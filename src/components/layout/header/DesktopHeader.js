...
const HeaderItem = lazy(() => import(/* webpackChunkName: "headerItem" */ '../../../components/shared/HeaderItem'));
const RightHeaderItems = lazy(() => import(/* webpackChunkName: "RightHeaderItems" */ './RightHeaderItems'));
