...
export const getVestingScheduleData = (startDate, endDate) => {
  ...
  while (currentDate <= endDate) {
    vestingData.push({
      ...
      'Network Rewards': networkRewardsVestingDataArray[i],
      'Community Rewards': communityRewardsVestingDataArray[i],
...
const networkRewardsVestingDataArray = [
...
const communityRewardsVestingDataArray = [
