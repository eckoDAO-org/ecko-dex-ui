    ...
    (module ${KADDEX_NAMESPACE}-read G
      ...
      (defun pair-info ()
        (let* (
          ...
          (amountB (${KADDEX_NAMESPACE}.liquidity-helper.get-add-liquidity-token-amount-after-swap (dec ${amountA}) ${token0} ${token1} (+ 1.0 ${slippage})))
          (reserveA (${KADDEX_NAMESPACE}.exchange.reserve-for p ${token0}))
          (amountA-after-swap (- (dec ${amountA}) (${KADDEX_NAMESPACE}.liquidity-helper.get-one-sided-liquidity-swap-amount reserveA (dec ${amountA}))))
